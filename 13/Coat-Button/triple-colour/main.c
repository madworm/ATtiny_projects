...
void breathe(uint16_t b_delay) {
	while (1) {
		fade(0,255,b_delay,0); // from, to, delay, color
		fade(255,0,b_delay,0);
		fade(0,255,b_delay,1); // from, to, delay, color
		fade(255,0,b_delay,1);
		fade(0,255,b_delay,2); // from, to, delay, color
		fade(255,0,b_delay,2);
	}
}
