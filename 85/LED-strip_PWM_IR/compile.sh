...
avr-g++  -o bin/Debug/source.elf obj/Debug/IR_receiver.o obj/Debug/main.o obj/Debug/system_ticker.o obj/Debug/uart.o   -mmcu=attiny85 -Wl,-Map=bin/Debug/source.elf.map,--cref -Wl,--gc-sections,--print-gc-sections -lm -lc -v
